...
class _RestaurantDetailPageState extends State<RestaurantDetailPage> {
  ...
  void didChangeDependencies() {
    ...
    if (_isFirstLoad) {
      _isFirstLoad = false;
      context.read<RestaurantProvider>().fetchRestaurantDetail(widget.restaurantId);
    }
  }
      ...
      body: Consumer<RestaurantProvider>(
        builder: (context, provider, child) {
          return switch (provider.restaurantDetailState) {
            ...
            SuccessState<RestaurantDetail>(:final data) =>
              _buildDetailContent(context, theme, data),
  ...
  Widget _buildDetailContent(BuildContext context, ThemeData theme, RestaurantDetail restaurant) {
